        ...
        <div className="two-col">
          <section className="panel big-text">
            ...
            <div className="mini-grid">
              {[
                ['VK', 'в форме — твоя личная страница (ник или vk.com/id…). Сообщество клуба подпиши отдельно по условиям.'],
                ['Telegram', 'в форме — твой @ник или ссылка на профиль. Канал клуба — отдельно по условиям.'],
                ['Форма', 'ФИО, VK и Telegram — все поля обязательны'],
                ['1 билет', 'не повторяй ФИО, VK и Telegram с другими заявками']
              ].map(([a, b]) => (
